...
public class MypageController {
	...
	public String addBookmark(@RequestParam("comNo") int comNo, @RequestParam("userNo") int userNo, @RequestParam("comName") String comName) {
	    // 북마크 객체 생성
	    UscBookMark uscBookMark = new UscBookMark();
	    uscBookMark.setComNo(comNo);  // comNo로 수정
	    uscBookMark.setUserNo(userNo);
	    uscBookMark.setUcSubscribed(UscBookMark.UcSubscribed.BOOKMARK);  // BOOKMARK로 설정

	    // 북마크 추가
	    ijp.addBookmark(comNo, userNo);  // 북마크 추가 메소드 호출
